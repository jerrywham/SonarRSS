...
define('FUNNEL_FEED_NAME',$title);
define('FUNNEL_FEED_DESCRIPTION','Un flux agrégé par Sonar\'RSS');
define('WEBSITE_REFERENCE_URL','http://warriordudimanche.net');
define('FUNNEL_FEED_URL','http://'.$_SERVER['SERVER_NAME'].$_SERVER['PHP_SELF'].'?tab='.$numonglet);
